...
def main():
    ...
    for rbm_file in os.listdir(RBM_MODELS_DIR):
        ...
        threshold, rbm_ari, rbm_rand_score, rbm_homogenity, rbm_completeness, rbm_v_measure_scores, rbm_mapped_labels = th_finder.find_threshold(thresholds=THRESHOLDS)

        ahc = AgglomerativeHierarchicalClustering(n_clusters=7, linkage="average")
