...
\maketitle
\todo{DM, PG: Uzupelnijcie / sprawdzcie dane, prosze.}
...
\begin{abstract}
	...
	quantum annealer are better or at least comparable with alternative
	training algorithms, according to the selected metrics. Our results
...
especially in the field of generative model \cite{Goodfellow2014}, and
...
Among others, RBMs have been used in computer vision, as a part of an
image processing system. Specifically, the authors of QBM4EO devised a
...
image segmentation. Moreover, we discuss the proposed solutions to the
problem therein. In the next section, we discuss quantum machine learning,
focusing especially on the building block of the model we propose. Here,
...
The task of image segmentation can be approached with a variety of algorithms, including both classical methods \cite{Chen2017} and those based on deep learning \cite{Badrinarayanan2017}. Among classical algorithms that are often used for segmentation are approaches like \cite{Chen2017}: thresholding, region-based, edge-detection, clustering.
...
% literature overview, solutions and shortcomings

Research on hyperspectral imaging at the pixel-level has grown in recent years, leading to an increasing number of scientific publications in this field \cite{Morchhale2016, González-Santiago2022, Yan2023, Sifnaios2024, Chen2024}.
...
\begin{figure}[H]
    \centering
    {\includegraphics[width=0.85\textwidth]{figures/experiments_and_results/plot_loss/rbm_plot_loss_sa.pdf}
    \caption[Learning curve of the RBM from the SA training.]{Learning curve of the RBM from the simulated annealing training. The blue line represents the loss value on the training dataset, and the red line represents the loss value on the validation dataset.}
    \label{fig:rbm_sa_learning_annealer}
    }
\end{figure}
