...
Sifnaios2024, Chen2024}. We therefore decided to pursue this direction in this
work.
...
Artificial intelligence is a technology at the intersection of mathematics and computer science. It includes a wide spectrum of methods and algorithms that enable machines to learn, resulting in a wide range of applications \cite{raschka2019, Goodfellow2016}. The origins of artificial intelligence are considered to be the Perceptron model presented conceptually in \cite{Mcculloch1943} and developed in \cite{Rosenblatt1958}. 
...
In the context of this work, we will use several unsupervised learning algorithms, for representation learning and dimensionality reduction and other clustering algorithms to perform image segmentation.
...
\section{Experiments and results}\label{experiments_and_results}
 ...
 The following subsections cover an analysis of the comparative performance of the both methods in the context of multispectral image segmentation.
