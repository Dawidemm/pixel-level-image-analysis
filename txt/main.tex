...
\chapter{Image Segmentation}\label{segmentation}
...
\chapter{Unsupervised Learning}\label{unsupervised_learning}
...
\section{Latent Bernoulli Autoencoder}\label{lbae_section}
...
\section{Restricted Boltzmann Machines}\label{rbm_section}
...
\section{Cluster Analysis}\label{cluster_analysis_section}
...
\chapter{Quantum Computing}\label{quantum_computing}
...
\section{Ising Model and Quadratic Unconstrained Binary Optimization}\label{inig_qubo_section}
...
\section{Adiabatic Quantum Computation and Quantum Annealing}\label{aqc_qa_section}
...
\section{D–Wave's Quantum Processing Units}\label{dwave_qpu_section}
...
\section{Data Preprocessing}\label{data_preprocessing_section}
...
\section{Proposed Model}\label{proposed_model_section}
...
\subsection{Data Processing Module --- LBAE}\label{lbae_implementation}
...
\subsection{Data Clustering Module --- RBM}\label{rbm_implementation}
...
\newpage
\section{Classical Model Training and Evaluation}
